...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  { name: "e2b_git_push", description: "Push an E2B workspace branch to GitHub; when owner/repo are supplied, KChat can automatically open a PR, poll CI, and optionally locate a Netlify Deploy Preview.", permission: "write", confirmationRequired: true, input: { type: "object", required: ["sandboxId", "branch"], properties: { sandboxId: { type: "string" }, branch: { type: "string" }, directory: { type: "string" }, owner: { type: "string" }, repo: { type: "string" }, base: { type: "string", default: "main" }, title: { type: "string" }, body: { type: "string" }, draft: { type: "boolean" }, siteId: { type: "string" } } } },
